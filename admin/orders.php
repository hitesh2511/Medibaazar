                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                            <td><?php echo '<img width="100px" height="100px" src="/Prescription/' . $data[$i]['Prescription'] . '" />'; ?></td>
                            <td>
                            ...
                            ?>
                                <td>
                                <button type="button" class="btn  btn-outline-success"><a style="text-decoration: none; color:black;" href="orders.php?Delivered=<?php echo $data[$i]['order_id'] ?>">&nbsp;Delivered&nbsp;</a></button>
                                </td>
                            <?php }elseif ($data[$i]['order_status'] == 2) {
                            ?>
                                <td>
                            ...
                            <td>
                            <?php if (!$data[$i]['Prescription']==null) {
                            ?>  
                            
                                <button type="button" class="btn  btn-outline-info"><a style="text-decoration: none; color:black;" href="view_image.php?image=Prescription/<?php echo $data[$i]['Prescription'] ?>"> &nbsp;View &nbsp; </a></button>
                            <?php } ?>
                            </td>                            
                            <td>
