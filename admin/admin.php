        ...
        ?>
            ...
            <form action="admin.php" method="POST">
                <div class="form-group">
                    ...
                    <input pattern="[A-Za-z_]{1,15}" type="text" class="form-control" placeholder="<?php global $encryptionKey; echo decryptData($data[0]['admin_fname'],$encryptionKey) ?>" name="admin_fname">
                ...
                <div class="form-group">
                    ...
                    <input pattern="[A-Za-z_]{1,15}" id="validationTooltip01" type="text" class="form-control" placeholder="<?php global $encryptionKey; echo decryptData($data[0]['admin_lname'],$encryptionKey) ?>" name="admin_lname">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<?php global $encryptionKey; echo decryptData($data[0]['admin_email'],$encryptionKey) ?>" name="admin_email">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php global $encryptionKey; echo decryptData($data[$i]['admin_fname'],$encryptionKey) ?></td>
                            <td><?php global $encryptionKey; echo decryptData($data[$i]['admin_lname'],$encryptionKey) ?></td>
                            <td><?php global $encryptionKey; echo decryptData($data[$i]['admin_email'],$encryptionKey) ?></td>
