<!---------------- Developer Name:- Hitesh Kumar Nandwani 
                   orderspre.php :-  order by Prescription details                 --------->
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="container">
            <div class="row align-items-start">
                ...
                <div class="col">
                    <br>
                    <form class="d-flex" method="GET" action="orderspre.php">
                        <input class="form-control me-2 col" type="search" name="search_order_id" placeholder="Search for order (ID)" aria-label="Search">
                        <button class="btn btn-outline-secondary" type="submit" name="search_order_prescrption" value="search">Search</button>
                    </form>
                    <br>
                </div>
            </div>
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    if (isset($_GET['search_order_prescrption'])) {
                        $query = search_order_prescrption();
                        if (!empty($query)) {
                            $data = $query;
                        } else {
                            get_redirect("orderspre.php");
                        }
                    }
                    $num = sizeof($data);
                    for ($i = 0; $i < $num; $i++) {
